...
interface TddLiteGeneratorOptions {
    tools?: string[];
    noInteractive?: boolean;
}

export class TddLiteGeneratorCommand {
    async execute(options: TddLiteGeneratorOptions = {}): Promise<void> {
        ...
        console.log(chalk.blue('\n📝 Generating TDD-Lite Generator workflow files...\n'));
        ...
        // Generate tdd-lite-generator workflow files for all configured tools
        let successCount = 0;
        let failCount = 0;
        ...
        for (const toolId of configuredTools) {
            ...
            if (configurator) {
                try {
                    // Generate only the tdd-lite-generator workflow file
                    const body = configurator['getBody']('tdd-lite-generator');
                    const relativePath = configurator['getRelativePath']('tdd-lite-generator');
                    ...
                    const frontmatter = configurator['getFrontmatter']('tdd-lite-generator');
        ...
        // Success message
        console.log(chalk.green(`\n✅ TDD-Lite Generator workflow files created successfully!\n`));
        console.log(chalk.blue('Next steps:'));
        console.log(chalk.gray('  1. Use /tdd-lite-generator in your AI tool to create TDD-Lites'));
        console.log(chalk.gray('  2. TDD-Lites will be saved to prompter/<slug>/tdd-lite.md\n'));
    }
