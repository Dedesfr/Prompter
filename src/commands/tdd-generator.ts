...
interface TddGeneratorOptions {
    tools?: string[];
    noInteractive?: boolean;
}

export class TddGeneratorCommand {
    async execute(options: TddGeneratorOptions = {}): Promise<void> {
        ...
        console.log(chalk.blue('\n📝 Generating TDD Generator workflow files...\n'));
        ...
        // Generate tdd-generator workflow files for all configured tools
        let successCount = 0;
        let failCount = 0;
        ...
        for (const toolId of configuredTools) {
            ...
            if (configurator) {
                try {
                    // Generate only the tdd-generator workflow file
                    const body = configurator['getBody']('tdd-generator');
                    const relativePath = configurator['getRelativePath']('tdd-generator');
                    ...
                    const frontmatter = configurator['getFrontmatter']('tdd-generator');
        ...
        // Success message
        console.log(chalk.green(`\n✅ TDD Generator workflow files created successfully!\n`));
        console.log(chalk.blue('Next steps:'));
        console.log(chalk.gray('  1. Use /tdd-generator in your AI tool to create TDDs'));
        console.log(chalk.gray('  2. TDDs will be saved to prompter/<slug>/tdd.md\n'));
    }
