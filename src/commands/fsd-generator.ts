...
interface FsdGeneratorOptions {
    tools?: string[];
    noInteractive?: boolean;
}

export class FsdGeneratorCommand {
    async execute(options: FsdGeneratorOptions = {}): Promise<void> {
        ...
        console.log(chalk.blue('\n📝 Generating FSD Generator workflow files...\n'));
        ...
        // Generate fsd-generator workflow files for all configured tools
        let successCount = 0;
        let failCount = 0;
        ...
        for (const toolId of configuredTools) {
            ...
            if (configurator) {
                try {
                    // Generate only the fsd-generator workflow file
                    const body = configurator['getBody']('fsd-generator');
                    const relativePath = configurator['getRelativePath']('fsd-generator');
                    ...
                    const frontmatter = configurator['getFrontmatter']('fsd-generator');
        ...
        // Success message
        console.log(chalk.green(`\n✅ FSD Generator workflow files created successfully!\n`));
        console.log(chalk.blue('Next steps:'));
        console.log(chalk.gray('  1. Use /fsd-generator in your AI tool to create FSDs'));
        console.log(chalk.gray('  2. FSDs will be saved to prompter/<slug>/fsd.md\n'));
    }
