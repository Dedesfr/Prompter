...
export class SkillCreatorCommand {
    async execute(options: SkillCreatorOptions = {}): Promise<void> {
        ...
        // Success message
        console.log(chalk.green(`\n✅ Skill creator workflow files created successfully!\n`));
